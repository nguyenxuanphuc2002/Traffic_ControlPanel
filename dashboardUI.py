...
class UI_Dashboard(object):
    def setupUi(self, Form):
        ...
        self.widget.setGeometry(QtCore.QRect(0, 20, 501, 1080))
        self.widget.setStyleSheet("background-color: #D9D9D9;")
        self.widget.setObjectName("widget")
        self.helloText = QtWidgets.QLabel(self.widget)
...
"border-radius:25px;")
        ...
        self.nameInfor = QtWidgets.QLabel(self.widget)
...
"border-radius:25px;")
        ...
        self.dateofbirthInfor = QtWidgets.QLabel(self.widget)
...
"border-radius:25px;")
        ...
        self.fieldListbtn = QtWidgets.QWidget(Form)
...
"border-radius:12px")
    ...
    def retranslateUi(self, Form):
        ...
        self.helloText.setText(_translate("Form", "Xin Chào Bạn !"))
        self.nameInfor.setText(_translate("Form", "Nguyễn Xuân Phúc"))
        self.dateofbirthInfor.setText(_translate("Form", "01/01/2022"))
        self.logoutButton.setText(_translate("Form", "Đăng Xuất"))
        self.listcamPage.setText(_translate("Form", "Danh sách Camera"))
        self.videoviolationPage.setText(_translate("Form", "Video vi phạm"))
        self.ChartPage.setText(_translate("Form", "Thống kê"))
        self.createaccountPage.setText(_translate("Form", "Tạo tại khoản"))
